...
enum Tabler {
    ...
    // Diff-status family. A colored glyph reads faster than a bare A/M/D letter, and
    // the square outline keeps all four the same visual weight in a scanned list.
    private static let squareOutline =
        "M4 6a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2v-12z"
    static let squarePlus = [squareOutline, "M9 12l6 0", "M12 9l0 6"]
    static let squareMinus = [squareOutline, "M9 12l6 0"]
    /// Tabler encodes the centre dot as a tiny arc pair so the stroke-only renderer
    /// draws it as a filled-looking point.
    static let squareDot = [squareOutline, "M11 12a1 1 0 1 0 2 0a1 1 0 1 0 -2 0"]
    static let squareArrow = [squareOutline, "M9 12l6 0", "M12 9l3 3l-3 3"]
