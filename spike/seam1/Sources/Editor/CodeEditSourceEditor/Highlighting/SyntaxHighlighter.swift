...
class SyntaxHighlighter: NSObject {
    static private let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "", category: "SyntaxHighlighter")
...
extension SyntaxHighlighter: @preconcurrency NSTextStorageDelegate {
...
extension SyntaxHighlighter: StyledRangeContainerDelegate {
...
extension SyntaxHighlighter: VisibleRangeProviderDelegate {
