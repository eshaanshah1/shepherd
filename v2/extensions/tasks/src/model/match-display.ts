...
/**
 * Re-exported rather than defined: this pair moved to the sdk when the palette's
 * transcript rows needed the same treatment, and `packages/ui` may not import an
 * extension. Every caller here keeps importing it from where it always was.
 */
